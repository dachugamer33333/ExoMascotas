      ...
      <div className="grid md:grid-cols-4 gap-4">
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-3 pl-12 rounded-2xl border border-gray-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition-all"
          />
        ...
        <div className="relative">
          <select
            ...
            className="w-full px-4 py-3 pl-12 rounded-2xl border border-gray-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none transition-all appearance-none bg-white"
          >
